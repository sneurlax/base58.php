...
def encode(hex):
    ...
    print(data[(0*__fullBlockSize):(0*__fullBlockSize+__fullBlockSize)])
    print(res)
    print(i * __fullEncodedBlockSize)
    print(encode_block(data[(0*__fullBlockSize):(0*__fullBlockSize+__fullBlockSize)], res, 0 * __fullEncodedBlockSize)) 
